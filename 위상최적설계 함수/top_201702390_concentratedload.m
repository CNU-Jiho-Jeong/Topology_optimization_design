...
function top_201702390_concentratedload(nelx,nely,volfrac,penal,rmin);
% top_201702390_concentratedload 함수 정의
...
% 고정된 자유도(맨 윗 노드들의 y요소들을 다 고정 시켜버렸다.)
fixeddofs   = [2:2*(nely+1):2*(nelx+1)*(nely+1)-2*nely];
